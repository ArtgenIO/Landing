...
export default function Galaxy(insideColor, outsideColor, hook) {
  ...
  config.insideColor = insideColor ?? '#f55726';
  config.outsideColor = outsideColor ?? '#8100ff';
  ...
  const tick = () => {
    ...
    let rf = window.requestAnimationFrame(tick);
